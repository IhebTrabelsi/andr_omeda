...
class ChatMember(models.Model):
    ...
    is_anonymous = models.BooleanField(_("is_anonymous"), blank=True)
    can_be_edited = models.BooleanField(_("can_be_edited"), blank=True)
    can_manage_chat = models.BooleanField(_("can_manage_chat"), blank=True)
    can_post_messages = models.BooleanField(_("can_post_messages"), blank=True)
    can_edit_messages = models.BooleanField(_("can_edit_messages"), blank=True)
    can_delete_messages = models.BooleanField(_("can_delete_messages"), blank=True)
    can_manage_voice_chats = models.BooleanField(_("can_manage_voice_chats"), blank=True)
    can_restrict_members = models.BooleanField(_("can_restrict_members"), blank=True)
    can_promote_members = models.BooleanField(_("can_promote_members"), blank=True)
    ...
    is_member = models.BooleanField(_("is_member"), blank=True)
    ...
    until_date = models.IntegerField(_("until_date"), blank=True)
