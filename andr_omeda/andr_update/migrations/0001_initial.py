# Generated by Django 3.1.7 on 2021-03-22 22:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inline_message_id', models.TextField(blank=True, verbose_name='inline_message_id')),
                ('from_user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='andr_update.andruser')),
            ],
        ),
        migrations.CreateModel(
            name='Document',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice_payload', models.TextField(verbose_name='invoice_payload')),
                ('shipping_query_from', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='andr_update.andruser')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='andr_update.andruser')),
                ('order_info', models.OneToOneField(blank=True, on_delete=django.db.models.deletion.CASCADE, to='andr_update.orderinfo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='andr_update.andruser')),
            ],
        ),
        migrations.AddField(
            model_name='poll',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.IntegerField(verbose_name='date')),
                ('chat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='andr_update.chat')),
                ('from_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='andr_update.andruser')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chat_member_update', models.OneToOneField(on_delete=django.db.models.deletion.RESTRICT, related_name='invite_link', to='andr_update.chatmemberupdated')),
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='andr_update.andruser')),
            ],
        ),
        migrations.AddField(
