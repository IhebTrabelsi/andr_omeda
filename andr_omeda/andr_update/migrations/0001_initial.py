...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Chat',
            fields=[
                ('id', models.BigIntegerField(default=0, primary_key=True, serialize=False, verbose_name='id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chat', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='message', to='andr_update.chat')),
                ('forward_from_chat', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.RESTRICT, related_name='forwarded_messages', to='andr_update.chat')),
                ...
                ('sender_chat', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.RESTRICT, related_name='sended_messages', to='andr_update.chat')),
            ],
        ),
        migrations.CreateModel(
            name='OrderInfo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('andr_id', models.OneToOneField(null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='update', to='andr_update.andrid')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice_payload', models.TextField(verbose_name='invoice_payload')),
                ('update', models.OneToOneField(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='shipping_query', to='andr_update.update')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update', models.OneToOneField(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='pre_checkout_query', to='andr_update.update')),
            ],
        ),
        migrations.CreateModel(
            name='PollOption',
        ...
        migrations.AddField(
            model_name='poll',
            name='update',
            field=models.OneToOneField(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='poll', to='andr_update.update'),
        ),
        migrations.CreateModel(
            name='PhotoSize',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('poll', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='explanation_entities', to='andr_update.messageentity')),
            ],
        ),
        migrations.AddField(
            model_name='message',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invite_link', models.OneToOneField(blank=True, on_delete=django.db.models.deletion.CASCADE, to='andr_update.update')),
                ('update_for_chat_member', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='chat_member', to='andr_update.update')),
                ('update_for_my_chat_member', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='my_chat_member', to='andr_update.update')),
        ...
        migrations.AddField(
            model_name='andruser',
            name='bot_sender',
            field=models.OneToOneField(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='via_bot', to='andr_update.message'),
        ),
        migrations.AddField(
            model_name='andruser',
            name='callback_query',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='callback_query_from', to='andr_update.callbackquery'),
        ),
        migrations.AddField(
            model_name='andruser',
            name='chosen_inline_result',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='chosen_inline_result_from', to='andr_update.choseninlineresult'),
        ),
        migrations.AddField(
            model_name='andruser',
            name='entity_mention',
            field=models.OneToOneField(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='user', to='andr_update.message'),
        ),
        migrations.AddField(
            model_name='andruser',
            name='forwarder',
            field=models.OneToOneField(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='forward_from', to='andr_update.message'),
        ),
        migrations.AddField(
            model_name='andruser',
            name='inline_query',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='inline_query_from', to='andr_update.inlinequery'),
        ),
        migrations.AddField(
            model_name='andruser',
            name='message',
            field=models.OneToOneField(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='message_from', to='andr_update.message'),
        ),
        migrations.AddField(
            model_name='andruser',
            name='pre_checkout_query',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='pre_checkout_query_from', to='andr_update.precheckoutquery'),
        ),
        migrations.AddField(
            model_name='andruser',
            name='proximity_alert_for_traveler',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='traveler', to='andr_update.proximityalerttriggered'),
        ),
        migrations.AddField(
            model_name='andruser',
            name='proximity_alert_for_watcher',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='watcher', to='andr_update.proximityalerttriggered'),
        ),
        migrations.AddField(
            model_name='andruser',
            name='shipping_query',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='shipping_query_from', to='andr_update.shippingquery'),
        ),
        migrations.AddField(
            model_name='andruser',
            name='user_leaving_member_message',
            field=models.OneToOneField(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='left_user_member', to='andr_update.message'),
        ),
        migrations.AddField(
            model_name='andruser',
            name='user_members_message',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='new_user_members', to='andr_update.message'),
        ),
        migrations.AddField(
            model_name='andruser',
            name='voice_chat_participant_invitation',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.RESTRICT, related_name='users', to='andr_update.voicechatparticipantsinvited'),
        ),
    ]
