...
if READ_DOT_ENV_FILE:
    ...
    if not ME_STILL_DEVELOPING:
        ...
        env.read_env(str(ROOT_DIR / ".envs" / ".local" / ".base"))
...
MIGRATION_MODULES = {"sites": "andr_omeda.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "andr_omeda.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Iheb Ben Said""", "iheb.trabel6@yahoo.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "andr_omeda.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "andr_omeda.users.adapters.SocialAccountAdapter"
